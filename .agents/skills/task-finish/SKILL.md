...
(AGENTS.md itself changes only for new non-negotiable constraints, changed build/test/run commands, or a wrong instruction — per `docs/context-management.md` §3 — and any such edit is flagged in the commit message.)

...
For each Critical/Major finding: **state the root cause before changing anything**, then apply the fix (AGENTS.md: explain the root cause before changing production code or tests).
